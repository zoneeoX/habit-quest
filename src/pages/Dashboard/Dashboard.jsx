...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      `}</style>
      <div className="w-screen min-h-screen max-h-full bg-slate-900 text-white py-48 overflow-hidden grid-background">
        {!isLoading ? (
          <div className="grid lg:grid-cols-3 grid-cols-1 backdrop-blur-sm gap-[5rem] max-w-6xl mx-auto bg-slate-800/50 p-10 rounded-xl border border-neutral-100/50">
