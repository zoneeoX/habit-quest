...
const GroupExplorer = () => {
  ...
  return (
    <div className="flex flex-col gap-6 font-poppins font-bold">
      <div className="bg-zinc-700 h-48 g flex flex-col gap-6 justify-center items-center rounded-xl shadow-lg border border-white/50 hover:bg-zinc-600 transition-all cursor-pointer">
